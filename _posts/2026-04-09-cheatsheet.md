...
| ------------- | ------------- | ------------- | ------------- |
[knit](https://knit.work/knit/) | `direction`, `bed+needle`, `carrier` | knit("+","f10","3") | Knit on `bed` at `needle` using `carriers` in `direction` direction
[tuck](https://knit.work/tuck/) | `direction`, `bed+needle`, `carrier` | tuck("+","f10","3") | Tuck on `bed` at `needle` using `carrier` in `direction` direction
...
in  | `carrier` | in("5") | Bring in yarn carriers
out | `carrier` | out("6") | Take out yarn carrier (not strictly necessary on kniterate and can cause issues -- only do this right at the end)
