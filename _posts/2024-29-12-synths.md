...
<span class="marginnote">
	<img src="{{ '/img/synths/hedgehog-bl.png' | prepend: site.baseurl }}" alt="vegetation health"/>hedgehog in the wild (at an <a href="https://lclo.otherkat.com/">LCLO</a> rehearsal)
</span>
