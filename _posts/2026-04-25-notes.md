...
<p class="topnote">This is the fifth in a series of blog posts about the <a href="https://cci.arts.ac.uk/~material/">Material Programming Project</a>. We are developing malleable knitting software for the <a href="https://www.kniterate.com/">Kniterate</a>, a semi-industrial knitting machine. This post is a bunch of notes from the past few weeks. The first post, on the Knitout project, is available <a href="https://soup.agnescameron.info/2025/09/20/kniterate.html">here</a>.</p>
...
In preparation for the second material programming workshop (which will take place at the start of May), I finished the first version of the [forked CMU visualiser](https://agnescameron.github.io/knitout-live-visualizer/), adapted for the Kniterate machine. (here's the [original](https://textiles-lab.github.io/knitout-live-visualizer/)). I also wrote a cheatsheet [guide](/2026/04/09/cheatsheet.html) to the tool and a couple of example scripts.
